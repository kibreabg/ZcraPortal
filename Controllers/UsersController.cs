...
namespace ZcraPortal.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(IZcraPortalRepo repository, IOptions<JWTSettings> jwtsettings, IMapper mapper, IConfiguration configuration)
        {
        ...
        {
            issuer = _configuration["IssuerUrl"].ToString();
